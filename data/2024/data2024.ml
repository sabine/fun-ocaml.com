...
module People = struct
  ...
  let of_metadata (m : metadata) : t =
    {
      slug = m.slug;
      img_src = "/2024/avatars/" ^ m.slug ^ ".jpg";
      name = m.name;
...
module RecommendedEvents = struct
  ...
  let all : event list =
    [
      {
        name = "BOBKonf";
        logo_url = "/2024/recommended-events/bobkonf.png";
...
module Sponsors = struct
  ...
  let all : sponsor list =
    [
      {
        name = "Tarides";
        logo_url = "/2024/sponsors/tarides.webp";
        url = "https://tarides.com";
      };
      {
        name = "Ahrefs";
        logo_url = "/2024/sponsors/ahrefs.svg";
        url = "https://ahrefs.com";
      };
      {
        name = "Jane Street";
        logo_url = "/2024/sponsors/jane_street.svg";
        url = "https://www.janestreet.com/";
      };
      {
        name = "LightSource";
        logo_url = "/2024/sponsors/lightsource.svg";
        url = "https://lightsource.ai/";
      };
      {
        name = "Hyper";
        logo_url = "/2024/sponsors/hyper.svg";
